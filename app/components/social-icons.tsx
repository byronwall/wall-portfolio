export const SocialIcons = {
  ...
  Resume: (props: React.SVGProps<SVGSVGElement>) => (
    <span className="flex items-center space-x-2 bg-black hover:bg-gray-800 text-white px-3 py-1.5 rounded-lg transition-colors duration-200">
      <svg
