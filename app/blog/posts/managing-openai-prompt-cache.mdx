---
title: Managing the prompt cache on OpenAI endpoints
...
OpenAI docs used while writing this: [Prompt caching](https://developers.openai.com/api/docs/guides/prompt-caching) and [Prompt engineering: save on cost and latency with prompt caching](https://developers.openai.com/api/docs/guides/prompt-engineering#save-on-cost-and-latency-with-prompt-caching).
