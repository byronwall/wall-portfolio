...
description: "An all-in-one workbench for flows, capability overviews, wireframes, and application maps"
date: "2026-08-28"
publishedAt: "2026-08-29"
summary: "An all-in-one workbench for flows, capability overviews, wireframes, and application maps"
...
- Latest update: [From a flow tool to an all-in-one diagram workbench](/blog/from-flow-tool-to-an-all-in-one-diagram-workbench)
...
Each `.diagram` source declares one type: flow, overview, wireframe, or application. The workbench shares discovery, navigation, validation, and rendering while each type keeps its own semantic model.

Within a flow document, the project separates four concerns that diagram tools often collapse into one structure:
...
- Canonical formatting and semantic checks for `.diagram` files
- Capability overviews, evidence-backed wireframes, and application maps
